  ...
  return (
    <>
      <div
        ...
        className='flex items-center text-slate-400 dark:text-slate-50 overflow-x-auto bg-gray-300 dark:bg-gray-700 py-8 my-16 lg:my-16'
        ...
        {dataList.map((data, key) => (
          <>
            <img
              ...
              src={data.image_src}
              alt={data.name}
              className={`shrink-0 w-28 h-28 md:w-44 md:h-52 lg:w-60 lg:h-52 bg-white rounded-lg mx-2 hover:border-red-500 border-4 border-gray-700 dark:bg-gray-400 dark:hover:border-lime-400 cursor-pointer hover:scale-125 ease-out duration-300 ${idx === key && 'scale-125 border-red-500 mx-8'}`}
